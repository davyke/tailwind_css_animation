...
function Hero() {
  return (
    <div className="w-[100] overflow-hidden perspective-9">
        ...
        <h1 className="absolute  sm:top-[10%]  xxs:top-[10%] md:top-[20%] z-77 md:text-5xl sm:text-xl md:font-medium sm:font-bold xxs:font-bold left-4 font-body text-white animate-banner forwards"> Discover the power Drive in Mazda cx5</h1>
        ...
        <button className="absolute bg-blue-700  sm:py-2 md:py-5 sm:text-base sm:px-5 xxs:px-5  md:px-8 rounded text-white left-4 sm:top-46 md:top-[48%] xxs:top-[26%] z-77 top-56 animate-bounce"> Order Now </button>
    </div>
  )
}
